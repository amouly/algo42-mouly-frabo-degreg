...
public class ControladorJuego implements Runnable {
	...
	public synchronized void removerDibujable(Dibujable unDibujable){
		synchronized (dibujables) {
	...
	private final List<KeyPressedObservador> keyPressedObservadores;
	private SuperficieDeDibujo superficieDeDibujo;
	private Reproductor reproductor;
	private Thread hiloAudio;
	private final boolean estaReproductorActivo;
